// ================================================
// GALERÍA OCEAN TWILIGHT - NAVEGACIÓN CORREGIDA
// ================================================
...
class ElegantGallery {
    ...
    preloadFirstImages() {
        // Solo para desktop - precargar primeras 4 imágenes
    ...
    handleModalClick(e) {
        // Cerrar al hacer clic en el backdrop o modal (pero no en los botones)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typeof galeriaImagenes !== 'undefined' && Array.isArray(galeriaImagenes) && galeriaImagenes.length > 0) {
        ...
        console.warn('galeriaImagenes no está definido. Define un array de URLs de imágenes antes de cargar el script.');
    }
});
