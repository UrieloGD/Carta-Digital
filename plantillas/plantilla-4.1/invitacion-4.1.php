...
$imagen_hero = $invitacion['imagen_hero'] ?: './plantillas/plantilla-4.1/img/hero.jpg';
$imagen_dedicatoria = $invitacion['imagen_dedicatoria'] ?: './plantillas/plantilla-4.1/img/dedicatoria.jpg';
$imagen_destacada = $invitacion['imagen_destacada'] ?: './plantillas/plantilla-4.1/img/destacada.jpg';
...
<head>
    ...
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/global.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/global.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/hero.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/hero.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/bienvenida.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/bienvenida.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/historia.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/historia.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/transition-image.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/transition-image.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/contador.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/contador.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/cronograma.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/cronograma.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/ubicaciones.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/ubicaciones.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/galeria.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/galeria.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/dresscode.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/dresscode.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/rsvp.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/rsvp.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/mesa-regalos.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/mesa-regalos.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/footer.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/footer.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-4.1/css/music-player.css?v=<?php echo filemtime('./plantillas/plantilla-4.1/css/music-player.css'); ?>">
...
<link rel="stylesheet" href="./plantillas/plantilla-4.1/css/music-player.css">
<script src="./plantillas/plantilla-4.1/js/music-player.js"></script>
<script>
(function() {
    const musicConfig = {
...
<script src="./plantillas/plantilla-4.1/js/mesa-regalos.js?v=<?php echo filemtime('./plantillas/plantilla-4.1/js/mesa-regalos.js'); ?>"></script>
<script src="./plantillas/plantilla-4.1/js/whatsapp.js?v=<?php echo filemtime('./plantillas/plantilla-4.1/js/whatsapp.js'); ?>"></script>
...
<script src="./plantillas/plantilla-4.1/js/galeria-rotacion.js?v=<?php echo filemtime('./plantillas/plantilla-4.1/js/galeria-rotacion.js'); ?>"></script>
