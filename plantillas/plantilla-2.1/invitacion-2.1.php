...
if ($dresscode_info) {
    // Solo asignar imagen si existe en la base de datos
    $img_dresscode_hombres = !empty($dresscode_info['hombres']) ? './' . ltrim($dresscode_info['hombres'], '/') : '';
    $img_dresscode_mujeres = !empty($dresscode_info['mujeres']) ? './' . ltrim($dresscode_info['mujeres'], '/') : '';
    ...
    // Si no hay dresscode_info, no mostrar imágenes
    $img_dresscode_hombres = '';
    $img_dresscode_mujeres = '';
...
$dresscode = $invitacion['dresscode'] ?: "Elegante casual. Colores plantilla-2.1es que armonicen con nuestro entorno verde.";
...
<head>
    ...
    <!-- Estilos -->
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/global.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/global.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/hero.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/hero.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/bienvenida.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/bienvenida.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/historia.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/historia.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/contador.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/contador.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/cronograma.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/cronograma.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/ubicaciones.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/ubicaciones.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/galeria.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/galeria.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/dresscode.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/dresscode.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/rsvp.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/rsvp.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/footer.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/footer.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/responsive.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/responsive.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-2.1/css/music-player.css?v=<?php echo filemtime('./plantillas/plantilla-2.1/css/music-player.css'); ?>" />
    ...
    <div class="container">
        <div class="bienvenida-content">
            ...
            <div class="bienvenida-text">
                <p>Con el corazón lleno de alegría, queremos invitarlos a ser parte del momento más importante de nuestras vidas.</p>
            </div>
...
<script src="./plantillas/plantilla-2.1/js/music-player.js"></script>
<script>
(function() {
    const musicConfig = {
...
<script src="./plantillas/plantilla-2.1/js/contador.js?v=<?php echo filemtime('./plantillas/plantilla-2.1/js/contador.js'); ?>"></script>
<script src="./plantillas/plantilla-2.1/js/compartir.js?v=<?php echo filemtime('./plantillas/plantilla-2.1/js/compartir.js'); ?>"></script>
<script src="./plantillas/plantilla-2.1/js/rsvp.js?v=<?php echo filemtime('./plantillas/plantilla-2.1/js/rsvp.js'); ?>"></script>
<script src="./plantillas/plantilla-2.1/js/whatsapp.js?v=<?php echo filemtime('./plantillas/plantilla-2.1/js/whatsapp.js'); ?>"></script>
<script src="./plantillas/plantilla-2.1/js/estadisticas.js?v=<?php echo filemtime('./plantillas/plantilla-2.1/js/estadisticas.js'); ?>"></script>
<script src="./plantillas/plantilla-2.1/js/invitacion.js?v=<?php echo filemtime('./plantillas/plantilla-2.1/js/invitacion.js'); ?>"></script>
<script src="./plantillas/plantilla-2.1/js/music-player.js?v=<?php echo filemtime('./plantillas/plantilla-2.1/js/music-player.js'); ?>"></script>
<script src="./plantillas/plantilla-2.1/js/galeria-rotacion.js?v=<?php echo filemtime('./plantillas/plantilla-2.1/js/galeria-rotacion.js'); ?>"></script>
