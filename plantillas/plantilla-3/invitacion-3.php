...
if ($dresscode_info) {
    $img_dresscode_hombres = !empty($dresscode_info['hombres']) ? './' . ltrim($dresscode_info['hombres'], '/') : './plantillas/plantilla-3/img/dresscode.webp';
    $img_dresscode_mujeres = !empty($dresscode_info['mujeres']) ? './' . ltrim($dresscode_info['mujeres'], '/') : './plantillas/plantilla-3/img/dresscode2.webp';
    ...
    $img_dresscode_hombres = './plantillas/plantilla-3/img/dresscode.webp';
    $img_dresscode_mujeres = './plantillas/plantilla-3/img/dresscode2.webp';
...
$dresscode = $invitacion['dresscode'] ?: "Elegante casual. Colores plantilla-3es que armonicen con nuestro entorno verde.";
