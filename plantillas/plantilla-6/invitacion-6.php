...
// Si no hay imágenes en la galería, usar las por defecto de plantilla-6
if (empty($galeria)) {
    $galeria = [
        "./plantillas/plantilla-6/img/galeria/pareja1.jpg",
        "./plantillas/plantilla-6/img/galeria/pareja2.jpg", 
        "./plantillas/plantilla-6/img/galeria/pareja3.jpg",
        "./plantillas/plantilla-6/img/galeria/pareja4.jpg",
        "./plantillas/plantilla-6/img/galeria/pareja5.jpg"
    ];
}
...
$imagen_hero = $invitacion['imagen_hero'] ?: './plantillas/plantilla-6/img/hero.jpg';
$imagen_dedicatoria = $invitacion['imagen_dedicatoria'] ?: './plantillas/plantilla-6/img/dedicatoria.jpg';
$imagen_destacada = $invitacion['imagen_destacada'] ?: './plantillas/plantilla-6/img/destacada.jpg';
...
<head>
    ...
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/global.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/global.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/hero.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/hero.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/bienvenida.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/bienvenida.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/historia.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/historia.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/transition-image.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/transition-image.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/contador.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/contador.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/cronograma.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/cronograma.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/ubicaciones.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/ubicaciones.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/galeria.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/galeria.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/dresscode.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/dresscode.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/rsvp.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/rsvp.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/mesa-regalos.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/mesa-regalos.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/footer.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/footer.css'); ?>" />
    <link rel="stylesheet" href="./plantillas/plantilla-6/css/music-player.css?v=<?php echo filemtime('./plantillas/plantilla-6/css/music-player.css'); ?>">
    
    <!-- Fuentes cursivas mejoradas -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Allura&family=Playfair+Display:ital,wght@0,400;0,500;0,600;1,400&family=Cormorant+Garamond:ital,wght@0,400;0,500;1,400&family=Lato:wght@300;400;700&display=swap" rel="stylesheet">
...
<!-- Sección Bienvenida Romance Clásico -->
...
<!-- Sección Historia Romance Clásico -->
...
<!-- Imagen de transición Romance Clásico -->
...
<link rel="stylesheet" href="./plantillas/plantilla-6/css/music-player.css">
<script src="./plantillas/plantilla-6/js/music-player.js"></script>
<script>
(function() {
    const musicConfig = {
...
<script src="./plantillas/plantilla-6/js/contador.js?v=<?php echo filemtime('./plantillas/plantilla-6/js/contador.js'); ?>"></script>
<script src="./plantillas/plantilla-6/js/compartir.js?v=<?php echo filemtime('./plantillas/plantilla-6/js/compartir.js'); ?>"></script>
<script src="./plantillas/plantilla-6/js/rsvp.js?v=<?php echo filemtime('./plantillas/plantilla-6/js/rsvp.js'); ?>"></script>
<script src="./plantillas/plantilla-6/js/mesa-regalos.js?v=<?php echo filemtime('./plantillas/plantilla-6/js/mesa-regalos.js'); ?>"></script>
<script src="./plantillas/plantilla-6/js/whatsapp.js?v=<?php echo filemtime('./plantillas/plantilla-6/js/whatsapp.js'); ?>"></script>
<script src="./plantillas/plantilla-6/js/estadisticas.js?v=<?php echo filemtime('./plantillas/plantilla-6/js/estadisticas.js'); ?>"></script>
<script src="./plantillas/plantilla-6/js/invitacion.js?v=<?php echo filemtime('./plantillas/plantilla-6/js/invitacion.js'); ?>"></script>
<script src="./plantillas/plantilla-6/js/music-player.js?v=<?php echo filemtime('./plantillas/plantilla-6/js/music-player.js'); ?>"></script>
<script src="./plantillas/plantilla-6/js/galeria-rotacion.js?v=<?php echo filemtime('./plantillas/plantilla-6/js/galeria-rotacion.js'); ?>"></script>
