            ...
            <div>
                ...
                <div class="social-media-card">
                    ...
                    <div class="contact-social-buttons">
                        <!-- WhatsApp -->
                        <a href="https://wa.me/525512345678" target="_blank" rel="noopener" class="contact-social-btn whatsapp">
                        ...
                        <!-- Facebook -->
                        <a href="https://facebook.com/tupagina" target="_blank" rel="noopener" class="contact-social-btn facebook">
                            <div class="social-icon-circle">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <!-- Instagram -->
                        <a href="https://instagram.com/tupagina" target="_blank" rel="noopener" class="contact-social-btn instagram">
                            <div class="social-icon-circle">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
